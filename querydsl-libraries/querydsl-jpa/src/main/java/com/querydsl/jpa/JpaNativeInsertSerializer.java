 ...
 * com.querydsl.jpa.hibernate.HibernateInsertClause} to bypass JPQL when value expressions cannot be
 * type-checked by Hibernate's HQL parser (e.g. schema-qualified function calls).
 */
